   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title">Our Client </h3>
            <div class="card-tools">
                  <button type="button" onclick="OurClient('tambah', '{{ route('client_post') }}', '')" class="btn btn-sm btn-primary"><i class="fas fa-plus"> </i> Our Client
            </div>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
                     ...
                     <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                        ...
                        @if(count($list) > 0)
                            @foreach($list as $key => $val)
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" onclick="OurClient('edit', '{{ route('client_post') }}', '{{ $val['id'] }}')" class="btn btn-sm btn-primary">
                                            Edit
                                        </button>
    ...
    var dialog = bootbox.dialog({
        ...
        message: '<form class="form-commentar">' +
                '<div class="form-group has-float-label">' +
                    '<input type="text" class="form-control" name="imagesAlt" placeholder="Nama Perusahaan." value="'+imagesAlt+'">' +
...
function OurClient(type, url, id) {
    let Title = 'Tambah';
    if(type === 'edit') {
      Title = 'Edit';
