...
<div class="row">
   ...
   <div class="card">
        <div class="card-header">
            <h3 class="card-title">List Templates </h3>
            <div class="card-tools">
                  <button type="button" onclick="Template('tambah', '{{ route('template_post') }}', '', '', '', '')" class="btn btn-sm btn-primary"><i class="fas fa-plus"> </i> Template
            </div>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
                            ...
                            @foreach($customer as $key => $val)
                                <div class="col-lg-4 col-md-4 col-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                          <h5 class="card-title">{{ $val['labels']['name'] }}</h5>
                                          <p class="card-text">
                                            <div class="badge {{ $val['isActive'] == 1 ? 'badge-info' : 'badge-danger' }}">{{ $val['isActive'] == 1 ? 'Active' : 'Non Active' }}</div>
                                          </p>
                                          <a href="javascript:;" onclick="Template('edit', '{{ route('template_post') }}', '{{ $val['id'] }}', '{{ $val['labels']['id'] }}', '{{ $val['imgHeader'] }}', '{{ $val['isActive'] }}')" class="btn btn-sm btn-block btn-warning">Edit</a>
                                        </div>
                                      </div>
                                </div>
                            @endforeach
