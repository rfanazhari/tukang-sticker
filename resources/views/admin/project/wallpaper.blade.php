...
<div class="row">
   ...
   <div class="card">
        <div class="card-header">
            <h3 class="card-title">List Wallpaper </h3>
            <div class="card-tools">
                  <button type="button" onclick="Wallpaper('tambah', '{{ route('wallpaper_post') }}', '', '', '', '')" class="btn btn-sm btn-primary"><i class="fas fa-plus"> </i> Template
            </div>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
...
<script>
    ...
    function Dialog(data) {
        ...
        var dialog = bootbox.dialog({
            title: data.Title+' Wallpaper by Project ',
            size: 'medium',
            message: '<form class="form-commentar">' +
                    ...
                    '<div class="form-group has-float-label">' +
                        ...
                        '<select class="form-control select2imgs" id="templates" name="templates" style="width: 100%;">' +
        ...
        dialog.init(function() {
            ...
            $('#templates').on('select2:select', function (e) {
                ...
                document.getElementById("templatesId").value = data.id;
            });
            ...
            templatesName   = $('[name="templatesId"]');
            ...
            $('.simpanLable').on('click', function(e) {
                ...
                if(templatesName.val() == "" || templatesName.val() == undefined) {
                    onlyAlert("Silahkan pilih Template Wallpaper.", false, "warning");
                    return;
                }
                ...
                postAjax(data.url, {
                    ...
                    "templatesName" : templatesName.val(),
    ...
    function Wallpaper(type, url, id, permalinkID, img, isActive) {
        let Title = 'Tambah';
