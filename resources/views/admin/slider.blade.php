      ...
      <div class="card">
         <div class="card-header">
            ...
            <div class="card-tools">
                  <button type="button" onclick="Slider('tambah', '{{ route('slider_post') }}', '')" class="btn btn-sm btn-primary"><i class="fas fa-plus"> </i> Slider
            </div>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
                     ...
                     <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                        ...
                        @if(count($list) > 0)
                            @foreach($list as $key => $val)
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" onclick="Slider('edit', '{{ route('slider_post') }}', '{{ $val['id'] }}')" class="btn btn-sm btn-primary">
                                            Edit
                                        </button>
    ...
    var dialog = bootbox.dialog({
        ...
        message: '<form class="form-commentar">' +
                '<div class="form-group has-float-label">' +
                    '<input type="text" class="form-control" name="imagesAlt" placeholder="Title Slider." value="'+imagesAlt+'">' +
                '</div>' +
                '<div class="form-group has-float-label">' +
                    '<input type="text" class="form-control" name="url" placeholder="Link URL" value="'+url+'">' +
                '</div>' +
                '<div class="form-group has-float-label">' +
                    '<input type="text" class="form-control" name="captions" placeholder="Sub Title Slider." value="'+captions+'">' +
